...
$onlyBotPerms[managechannel;{newEmbed:{description:<:btt_EC_error:956514158759776256> | **$userTag[$authorID]** Bot Requires Manage Channel permission(s) to run this command.}{color:2F3136}}]      $onlyPerms[manageserver;<@$authorID>, You Need Manage Server Permission To Execute This Command.]
...
type: "interaction",
prototype: "button",
code: `$modifyChannelPerms[$guildID;$getServerVar[smreg1];+sendmessage] $channelSendMessage[$getServerVar[smreg1];@everyone{newEmbed: {description:📣 **Registration Started**\n📣 **Available Slots**: $getServerVar[smslots1]\n📣 **Required Tags**: $getServerVar[smtags1]\n\n**Make Sure To Use Team Name -\nin your registration message to make bot read your message.**}{thumbnail:$serverIcon[$guildID]}{color:00FF99}}]  $resetServerVar[smconfigid] $deleteMessage[$getServerVar[smconfigid];$channelID]                    $interactionReply[;{newEmbed: {description:Registration Started in <#$getServerVar[smreg1]>}{color:00FF99}};;;;yes]
...
type: "interaction",
prototype: "button",
code: `$modifyChannelPerms[$guildID;$getServerVar[smreg2];+sendmessage] $channelSendMessage[$getServerVar[smreg2];@everyone{newEmbed: {description:📣 **Registration Started**\n📣 **Available Slots**: $getServerVar[smslots2]\n📣 **Required Tags**: $getServerVar[smtags2]\n\n**Make Sure To Use Team Name -\nin your registration message to make bot read your message.**}{thumbnail:$serverIcon[$guildID]}{color:00FF99}}]  $resetServerVar[smconfigid] $deleteMessage[$getServerVar[smconfigid];$channelID]                    $interactionReply[;{newEmbed: {description:Registration Started in <#$getServerVar[smreg2]>}{color:00FF99}};;;;yes]
...
type: "interaction",
prototype: "button",
code: `$modifyChannelPerms[$guildID;$getServerVar[smreg3];+sendmessage] $channelSendMessage[$getServerVar[smreg3];@everyone{newEmbed: {description:📣 **Registration Started**\n📣 **Available Slots**: $getServerVar[smslots3]\n📣 **Required Tags**: $getServerVar[smtags3]\n\n**Make Sure To Use Team Name -\nin your registration message to make bot read your message.**}{thumbnail:$serverIcon[$guildID]}{color:00FF99}}]  $resetServerVar[smconfigid] $deleteMessage[$getServerVar[smconfigid];$channelID]                    $interactionReply[;{newEmbed: {description:Registration Started in <#$getServerVar[smreg3]>}{color:00FF99}};;;;yes]
...
type: "interaction",
prototype: "button",
code: `$modifyChannelPerms[$guildID;$getServerVar[smreg4];+sendmessage] $channelSendMessage[$getServerVar[smreg4];@everyone{newEmbed: {description:📣 **Registration Started**\n📣 **Available Slots**: $getServerVar[smslots4]\n📣 **Required Tags**: $getServerVar[smtags4]\n\n**Make Sure To Use Team Name -\nin your registration message to make bot read your message.**}{thumbnail:$serverIcon[$guildID]}{color:00FF99}}]  $resetServerVar[smconfigid] $deleteMessage[$getServerVar[smconfigid];$channelID]                    $interactionReply[;{newEmbed: {description:Registration Started in <#$getServerVar[smreg4]>}{color:00FF99}};;;;yes]
...
type: "interaction",
prototype: "button",
code: `$modifyChannelPerms[$guildID;$getServerVar[smreg5];+sendmessage] $channelSendMessage[$getServerVar[smreg5];@everyone{newEmbed: {description:📣 **Registration Started**\n📣 **Available Slots**: $getServerVar[smslots5]\n📣 **Required Tags**: $getServerVar[smtags5]\n\n**Make Sure To Use Team Name -\nin your registration message to make bot read your message.**}{thumbnail:$serverIcon[$guildID]}{color:00FF99}}]  $resetServerVar[smconfigid] $deleteMessage[$getServerVar[smconfigid];$channelID]                    $interactionReply[;{newEmbed: {description:Registration Started in <#$getServerVar[smreg5]>}{color:00FF99}};;;;yes]
